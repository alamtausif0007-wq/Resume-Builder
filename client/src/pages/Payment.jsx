...
const Payment = () => {
    ...
    // Redirect subscribed users immediately
    ...
    return (
      <div className="min-h-screen bg-[#030712] flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl text-center">
          ...
          <p className="text-slate-400 mb-8">Please log in to access the payment page.</p>
          <button 
  ...
  // If Razorpay is loading
  if (!razorpayLoaded) {
    return (
      <div className="min-h-screen bg-[#030712] flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl text-center">
          <h2 className="text-2xl font-semibold text-white mb-4 animate-pulse">Loading...</h2>
          <p className="text-slate-400">Please wait while we load the payment gateway.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#030712] flex flex-col items-center py-24 px-6 relative">
      ...
      <h1 className="text-4xl md:text-5xl font-bold  bg-gradient-to-r from-emerald-300 via-emerald-400 to-emerald-600 bg-clip-text text-transparent   mb-10 relative z-10 text-center">Choose Your AI Advantage</h1>
      ...
      <div className="w-full max-w-md p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl relative z-10 text-center">
        ...
        <button 
          className="btn-neon w-full py-4 rounded-xl text-lg disabled:opacity-50 disabled:cursor-not-allowed"
