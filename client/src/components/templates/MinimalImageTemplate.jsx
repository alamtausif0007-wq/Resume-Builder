                                ...
                                {data.projects.map((project, index) => (
                                    <div key={index}>
                                        ...
                                        <div className="flex gap-2">
                                            {project.link && (
                                                <a href={project.link.startsWith('http') ? project.link : `https://${project.link}`} target="_blank" rel="noopener noreferrer" className="text-sm hover:underline" style={{ color: accentColor }}>
                                                    Link
                                                </a>
                                            )}
                                            {project.link && project.github && <span className="text-sm text-zinc-400">|</span>}
                                            {project.github && (
                                                <a href={project.github.startsWith('http') ? project.github : `https://${project.github}`} target="_blank" rel="noopener noreferrer" className="text-sm hover:underline" style={{ color: accentColor }}>
                                                    GitHub
                                                </a>
                                            )}
                                        </div>
                        ...
                        <section className="mt-8">
                            ...
                            <div className="space-y-4">
                                {data.certifications.map((cert, index) => (
                                    <div key={index}>
                                        <h3 className="text-md font-medium text-zinc-800 mt-3">{cert.name}</h3>
                                        {cert.url && (
                                            <a href={cert.url.startsWith('http') ? cert.url : `https://${cert.url}`} target="_blank" rel="noopener noreferrer" className="text-sm hover:underline" style={{ color: accentColor }}>
                                                Link
                                            </a>
                                        )}
                                    </div>
