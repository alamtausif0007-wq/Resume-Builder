									...
									<div className="flex justify-between items-start">
										<div>
                                            ...
                                            <div className="flex gap-2">
                                                {p.link && (
                                                    <a href={p.link.startsWith('http') ? p.link : `https://${p.link}`} target="_blank" rel="noopener noreferrer" className="text-sm hover:underline" style={{ color: accentColor }}>
                                                        Link
                                                    </a>
                                                )}
                                                {p.link && p.github && <span className="text-sm text-gray-400">|</span>}
                                                {p.github && (
                                                    <a href={p.github.startsWith('http') ? p.github : `https://${p.github}`} target="_blank" rel="noopener noreferrer" className="text-sm hover:underline" style={{ color: accentColor }}>
                                                        GitHub
                                                    </a>
                                                )}
                                            </div>
